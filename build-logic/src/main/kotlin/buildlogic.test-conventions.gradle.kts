...
fun JvmTestSuite.applyMockitoAgent() {
    dependencies {
...
// Concordion hasn't updated in 9 years, update to Guage for specs?
                // https://gauge.org (From makes of Selenium)
