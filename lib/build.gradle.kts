...
//    implementation("org.jetbrains.kotlin:kotlin-stdlib-jdk8")
    ...
    // testImplementation("org.jacoco:org.jacoco.core:0.8.9")


}
configure<Djaxonomy_kotlin_test_conventions_gradle.KotlinTestKitExtension> {
    useKotlinTestKit.set(Djaxonomy_kotlin_test_conventions_gradle.KotlinTestKits.KoTest)
}
